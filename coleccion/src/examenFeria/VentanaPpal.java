...
public class VentanaPpal extends JFrame
{
	...
	private JButton botonAnadirConsumicion;
	...
	public VentanaPpal(Principal controlador)
	{
		...
		radioPequeno = new JRadioButton("Peque\u00F1o");
		buttonGroup.add(radioPequeno);
								...
								.addGroup(gl_panel.createSequentialGroup()
										...
										.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
												.addGroup(gl_panel.createSequentialGroup()
														...
														.addPreferredGap(ComponentPlacement.RELATED)
														.addComponent(radioPequeno, GroupLayout.PREFERRED_SIZE, 86, GroupLayout.PREFERRED_SIZE))
		...
		gl_panel.linkSize(SwingConstants.HORIZONTAL, new Component[] {radioGrande, radioMediano, radioPequeno});
		...
		botonAnadirConsumicion = new JButton("A\u00F1adir consumici\u00F3n al socio");
		botonAnadirConsumicion.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) 
			{
				botonAnadirConsumicionPulsado();
			}
		});
			...
			gl_panel_2.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_panel_2.createSequentialGroup()
					.addGroup(gl_panel_2.createParallelGroup(Alignment.LEADING)
						...
						.addComponent(botonAnadirConsumicion, GroupLayout.DEFAULT_SIZE, 264, Short.MAX_VALUE))
					.addContainerGap())
		);
		gl_panel_2.setVerticalGroup(
			gl_panel_2.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel_2.createSequentialGroup()
					...
					.addComponent(botonAnadirConsumicion)
					.addPreferredGap(ComponentPlacement.UNRELATED)
	...
	protected void botonAnadirConsumicionPulsado() 
	{
		if(this.comboSocios.getSelectedIndex()==0)
			this.error("Debe seleccionar un socio.");	
		else
			...
			{
				this.controlador.anadeConsumicion((Socio)this.comboSocios.getSelectedItem(),
	...
	protected void botonBorrarArticuloPulsado() 
	{
		...
		else
		{
			...
			if(this.controlador.hayCuentaPendienteConEseArticulo(this.campoArticulo.getText(),tamano))
				this.error("No puede borrar el art�culo porque hay cuentas sin pagar que lo contienen.");
			else

				if(this.controlador.borraArticulo(this.campoArticulo.getText(),tamano)==false)
	...
	public void actualizaComboArticulos() 
	{
		...
		this.comboArticulos.addItem(new Articulo("seleccione art�culo ...",""));
		...
		if(this.campoArticulo.getText().isEmpty())
			...
			else
			{
				try
				{
					...
					if(this.controlador.anadeArticulo(this.campoArticulo.getText(),
							precio,
							tamano)==false)
